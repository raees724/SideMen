...
module.exports = {
    ...
    getAllOrders:()=>{
        return new Promise(async(resolve, reject) => {
            ...
            console.log(allOdres,"alllllllllllllllllll");
            resolve(allOdres)
        })
    ...
    getAllDelOrders:()=>{
        return new Promise(async(resolve, reject) => {
            ...
            let allOdres=await db.get().collection(collection.ORDER_COLLECTION).find({status:"delivered"}).sort({$natural:-1}).toArray()
            console.log(allOdres,"alllllllllllllllllll");
            resolve(allOdres)
        })
